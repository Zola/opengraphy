...
var jaExtra = map[string]string{
	...
	"load_pair":                          "作品を読み込み",
	"pk_helper":                          "クリックしたくなるプレビューを選んでください。スコアは隠され、第一印象だけで判断できます。",
	"pk_encourage":                       "良い選択です。5 組のプレビューに公平なフィードバックを届けました。",
	"pk_ten":                             "10 ラウンド完了しました。続けるか、ランキングを見に行きましょう。",
	"pk_finished":                        "ありがとうございます。30 回の丁寧な投票でこのラウンドは十分です。",
	"pk_continue":                        "投票を続ける",
	"pk_view_leaderboard":                "ランキングを見る",
	"pk_error":                           "まだペアを作るだけの対象プレビューがありません。",
	...
	"admin_eyebrow":                      "管理",
	"admin_gallery_title":                "ギャラリー管理",
	"admin_gallery_body":                 "ギャラリーの永続化状態を確認し、同期し、公開ウォールから不要な作品を削除するための非公開コントロールです。",
	"admin_redis_recent":                 "Redis の新着",
	"admin_sqlite_works":                 "SQLite の作品",
	"admin_total":                        "合計",
	"admin_sync":                         "Redis を SQLite に同期",
	"admin_seed":                         "空なら初期作品を追加",
	"admin_works":                        "作品一覧",
	"admin_open_gallery":                 "公開ギャラリーを開く",
	"admin_remove_confirm":               "この作品を公開ギャラリーから削除しますか？",
	"admin_remove":                       "削除",
	"admin_no_works":                     "作品はありません。",
	"score_label":                        "スコア",
	"fetch_label":                        "取得",
	"source_label":                       "ソース",
	"cached":                             "キャッシュ",
...
var koExtra = map[string]string{
	...
	"load_pair":                          "작품 불러오기",
	"pk_helper":                          "더 클릭하고 싶은 미리보기를 선택하세요. 점수는 숨겨져 첫인상만으로 판단할 수 있습니다.",
	"pk_encourage":                       "좋은 선택입니다. 다섯 쌍의 미리보기에 더 공정한 피드백을 주었습니다.",
	"pk_ten":                             "10라운드가 끝났습니다. 계속 판단하거나 순위를 확인하세요.",
	"pk_finished":                        "감사합니다. 30번의 신중한 선택이면 이번 라운드는 충분합니다.",
	"pk_continue":                        "계속 투표",
	"pk_view_leaderboard":                "순위 보기",
	"pk_error":                           "아직 쌍을 만들 만큼 적합한 미리보기가 없습니다.",
	...
	"admin_eyebrow":                      "관리",
	"admin_gallery_title":                "갤러리 관리",
	"admin_gallery_body":                 "갤러리 영속성 상태를 확인하고 동기화하며 공개 갤러리에서 부적합한 작품을 제거하는 비공개 도구입니다.",
	"admin_redis_recent":                 "Redis 최근 작품",
	"admin_sqlite_works":                 "SQLite 작품",
	"admin_total":                        "합계",
	"admin_sync":                         "Redis를 SQLite에 동기화",
	"admin_seed":                         "비어 있으면 기본 작품 추가",
	"admin_works":                        "작품 목록",
	"admin_open_gallery":                 "공개 갤러리 열기",
	"admin_remove_confirm":               "이 작품을 공개 갤러리에서 제거할까요?",
	"admin_remove":                       "제거",
	"admin_no_works":                     "작품이 없습니다.",
	"score_label":                        "점수",
	"fetch_label":                        "가져오기",
	"source_label":                       "소스",
	"cached":                             "캐시",
...
var esExtra = map[string]string{
	...
	"pk_helper":           "Elige la vista previa que parezca más clicable. Las puntuaciones permanecen ocultas para decidir por primera impresión.",
	"pk_encourage":        "Buen ojo. Ya ayudaste a cinco vistas previas a recibir feedback más justo.",
	"pk_ten":              "Diez rondas listas. Sigue votando pares nuevos o mira el ranking.",
	"pk_finished":         "Gracias. Treinta elecciones cuidadosas son suficientes para esta ronda.",
	"pk_continue":         "Seguir votando",
	"pk_view_leaderboard": "Ver ranking",
	"pk_error":            "Aún no hay suficientes vistas previas calificadas para formar un par.",
	...
	"admin_eyebrow":        "Admin",
	"admin_gallery_title":  "Mantenimiento de galería",
	"admin_gallery_body":   "Controles privados para revisar la persistencia de la galería y quitar trabajos del muro público.",
	"admin_redis_recent":   "Recientes en Redis",
	"admin_sqlite_works":   "Trabajos en SQLite",
	"admin_total":          "Total",
	"admin_sync":           "Sincronizar Redis con SQLite",
	"admin_seed":           "Insertar ejemplos si está vacío",
	"admin_works":          "Trabajos",
	"admin_open_gallery":   "Abrir galería pública",
	"admin_remove_confirm": "¿Quitar este trabajo de la galería pública?",
	"admin_remove":         "Quitar",
	"admin_no_works":       "No hay trabajos.",
...
var frExtra = map[string]string{
	...
	"pk_helper":           "Choisissez l’aperçu qui donne le plus envie de cliquer. Les scores restent cachés pour juger à la première impression.",
	"pk_encourage":        "Bon œil. Vous avez aidé cinq aperçus à recevoir un retour plus juste.",
	"pk_ten":              "Dix manches terminées. Continuez à voter ou consultez le classement.",
	"pk_finished":         "Merci. Trente choix attentifs suffisent pour cette manche.",
	"pk_continue":         "Continuer à voter",
	"pk_view_leaderboard": "Voir le classement",
	"pk_error":            "Pas assez d’aperçus qualifiés pour former une paire.",
	...
	"admin_eyebrow":        "Admin",
	"admin_gallery_title":  "Maintenance de la galerie",
	"admin_gallery_body":   "Contrôles privés pour vérifier la persistance de la galerie et retirer des aperçus du mur public.",
	"admin_redis_recent":   "Récents Redis",
	"admin_sqlite_works":   "Aperçus SQLite",
	"admin_total":          "Total",
	"admin_sync":           "Synchroniser Redis vers SQLite",
	"admin_seed":           "Ajouter les exemples si vide",
	"admin_works":          "Aperçus",
	"admin_open_gallery":   "Ouvrir la galerie publique",
	"admin_remove_confirm": "Retirer cet aperçu de la galerie publique ?",
	"admin_remove":         "Retirer",
	"admin_no_works":       "Aucun aperçu trouvé.",
...
var deExtra = map[string]string{
	...
	"pk_helper":           "Wählen Sie die Vorschau, die am klickbarsten wirkt. Scores bleiben verborgen, damit der erste Eindruck zählt.",
	"pk_encourage":        "Guter Blick. Sie haben fünf Vorschauen zu fairerem Feedback verholfen.",
	"pk_ten":              "Zehn Runden abgeschlossen. Stimmen Sie weiter ab oder sehen Sie die Rangliste an.",
	"pk_finished":         "Danke. Dreißig sorgfältige Entscheidungen reichen für diese Runde.",
	"pk_continue":         "Weiter abstimmen",
	"pk_view_leaderboard": "Rangliste ansehen",
	"pk_error":            "Noch nicht genug qualifizierte Vorschauen für ein Paar.",
	...
	"admin_eyebrow":        "Admin",
	"admin_gallery_title":  "Galerie-Wartung",
	"admin_gallery_body":   "Private Werkzeuge zum Prüfen der Galerie-Persistenz und zum Entfernen von Einträgen aus der öffentlichen Wand.",
	"admin_redis_recent":   "Redis aktuell",
	"admin_sqlite_works":   "SQLite Einträge",
	"admin_total":          "Gesamt",
	"admin_sync":           "Redis nach SQLite synchronisieren",
	"admin_seed":           "Beispiele einfügen, wenn leer",
	"admin_works":          "Einträge",
	"admin_open_gallery":   "Öffentliche Galerie öffnen",
	"admin_remove_confirm": "Diesen Eintrag aus der öffentlichen Galerie entfernen?",
	"admin_remove":         "Entfernen",
	"admin_no_works":       "Keine Einträge gefunden.",
