...
var zhTWExtra = map[string]string{
	...
	"metadata_summary_title": "Metadata 摘要",
	...
	"diag_redirect_chain_long_message": "重定向鏈太長。", "diag_redirect_chain_long_fix": "請讓社群 crawler 的重定向保持簡短且穩定。",
	...
	"diag_image_unreachable_message": "預覽圖片無法抓取。", "diag_image_unreachable_fix": "請檢查圖片狀態、重定向、robots 和 content type。",
